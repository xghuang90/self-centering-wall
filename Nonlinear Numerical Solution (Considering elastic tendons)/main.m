...
close all
 ...
 % c=4.945; % the cofficient of the viscous damper
 ...
 thetay=2*(asin((Fu-P0)/(2*b*kp))); % rotation angle of the snap of the tendons
 ...
 for flag1 =1:numXc
	...
	for flag2 =1:numYc
		...
		[time, theta] = odeme( T, theta0, dtheta0 , st,  Io, m,g, R, alpha, b, c, P0, kp, ag, omega, phi, Tex, thetay,r );
